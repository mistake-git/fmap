...
var fieldToTextField = function (_a) {
    ...
    return __assign(__assign(__assign({}, props), field), { error: showError, helperText: showError ? fieldError : props.helperText, disabled: (disabled !== null && disabled !== void 0 ? disabled : isSubmitting) });
};
...
var fieldToSwitch = function (_a) {
    ...
    return __assign(__assign(__assign({ disabled: (disabled !== null && disabled !== void 0 ? disabled : isSubmitting) }, props), field), { value: field.name, checked: field.value });
};
...
var fieldToCheckbox = function (_a) {
    var field = _a.field, isSubmitting = _a.form.isSubmitting, disabled = _a.disabled, props = __rest(_a, ["field", "form", "disabled"]);
    return __assign(__assign(__assign({ disabled: (disabled !== null && disabled !== void 0 ? disabled : isSubmitting) }, props), field), { checked: field.value, value: field.value ? 'checked' : '' });
};
...
var fieldToSelect = function (_a) {
    ...
    return __assign(__assign(__assign({ disabled: (disabled !== null && disabled !== void 0 ? disabled : isSubmitting) }, props), field), { onChange: onChange });
};
